...
optimal_profit, weight_of_included_items, selected_items = knapsack.net_zero_knapsack(random_items, 50)
print(optimal_profit)
print(weight_of_included_items)
print_items_info(selected_items)

optimal_profit, weight_of_included_items, selected_items = knapsack.net_zero_knapsack(tricky_test_items, 5)
print(optimal_profit)
print(weight_of_included_items)
print_items_info(selected_items)
